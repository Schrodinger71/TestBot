...
from config import AUTHOR, GIT_PAT_TOKEN, REPO

API_URL = f'https://api.github.com/repos/{AUTHOR}/{REPO}/actions/runs?workflow=deploy.yml' # !!!!!
...
async def check_workflows():
    ...
    try:
        ...
        for run in workflows.get("workflow_runs", []):
            ...
            if run_name == "Deploy Discord AnagariBot":
